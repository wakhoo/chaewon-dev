...
const PostCard = ({ post }) => {
    console.log(post);
    return (
        <div className='mt-10 bg-lightOlive shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            ...
            <div className="text-center">
                <Link href={`/post/${post.slug}`}>
                    <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-darkGreen text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
                </Link>
            </div>
        </div >
    )
